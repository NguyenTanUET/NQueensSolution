...
def generate_clauses_seq(n, board):
    ...
    # Các biến trên board được tạo từ 1 đến n*n, do đó biến tiếp theo:
    next_aux_var = n * n + 1
...
# Hàm giải N-Queens sử dụng Sequential Counter Encoding
